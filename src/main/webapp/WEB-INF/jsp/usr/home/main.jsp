...
<section class="mt-5">
	<div class="container mx-auto px-3">
		...
		<span id="menu-navi">
			...
			<button type="button" class="btn btn-default btn-sm move-day" data-action="move-prev">&lt;</button>
			<button type="button" class="btn btn-default btn-sm move-day" data-action="move-next">&gt;</button>
			<button type="button" class="btn btn-default btn-sm move-month-view" data-action="move-month-view">Month</button>
			<button type="button" class="btn btn-default btn-sm move-week-view" data-action="move-week-view">Week</button>
			<button type="button" class="btn btn-default btn-sm move-day-view" data-action="move-day-view">Day</button>
		</span>
